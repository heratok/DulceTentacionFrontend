...
class BillingSelectProductView(Container):
    def __init__(self, page=Page):
        ...
        self.search_text_field = SearchTextFieldCustom2(
            hint_text="Buscar Producto por nombre o referencia...",
            on_change=lambda e: (),
        )
        data = [
            {
...
class BillingSelectProductList(Container):
    ...
    def add_item_widget(self, data):
        ...
        self.content.content.controls = [item.build() for item in self.listItemsWidget]
        self.content.update()
